...
public class Language_v2 {
	...
	public static void main(String[] args) {
		...
		String write_file = "C:\\Documents and Settings\\Jan\\workspace\\openemr\\OpenEmr-Helper\\src\\utils\\sql_lang.txt";
	...
	private static void updateline(String line, PrintWriter writer) {
		...
		if (tokenized.length > 1) {
			if (tokenized[1].trim().length() > 0) {				
				...
				newline = "#IfNotRow2Dx2 list_options list_id language option_id " + option_id + " title " + language;
				...
				newline = "INSERT INTO 'list_options' ( list_id, option_id, title, seq, is_default, option_value ) VALUES ('language', '" + option_id + "', '" + language + "', " + i + ", 0, 0);";
				/*System.out.println(newline);
				...
				newline = "#IfRow2D list_options list_id language option_id " + option_id;
				//System.out.println(newline);
				writer.println(newline);
				
				newline = "UPDATE 'list_options' SET 'list_options'.'notes' = '" + code + "' WHERE 'list_options'.'option_id' = '" + option_id + "';";
				/*System.out.println(newline);
				System.out.println("#EndIf");
				System.out.println();*/
				writer.println(newline);
				...
				newline = "#IfRow2D list_options list_id language title " + language;
				//System.out.println(newline);
				writer.println(newline);
				
				newline = "UPDATE 'list_options' SET 'list_options'.'notes' = '" + code + "' WHERE 'list_options'.'title' = '" + language + "';";
				/*System.out.println(newline);
				System.out.println("#EndIf");
				System.out.println();*/
				writer.println(newline);
